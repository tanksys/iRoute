...
user_mongo_url = "mongodb://user-mongodb.socialnetwork-db.svc.cluster.local:27017/"
...
post_mongodb_url = "mongodb://post-storage-mongodb.socialnetwork-db.svc.cluster.local:27017/"
